...
const Perfil = () => {
  ...
  return (
    <PerfilCss>
      ...
      <p>Programador web front-end Jr autodidata, estudo desenvolvimento web técnologo na Unopar,
         moro em Maringá Pr, tenho 27 anos de idade, estudo programação a 1 ano, conhecimento e 
         experiência em projetos próprios com as linguagem JavaScript, React Js, NextJs, 
         além de ferramentas como o bootstrap, Git, GitHub, API, Figma. Conhecimento basico 
         em back-end com nodejs, express, sequelize e mysql.
